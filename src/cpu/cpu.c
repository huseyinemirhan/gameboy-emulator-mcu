...
const opcode_func opcode_func_table[256] = {
    ...
    [0x80]=op_80, [0x81]=op_81, [0x82]=op_82, [0x83]=op_83, [0x84]=op_84, [0x85]=op_85, [0x86]=op_86, [0x87]=op_87, // ADD
    [0x88]=op_88, [0x89]=op_89, [0x8A]=op_8A, [0x8B]=op_8B, [0x8C]=op_8C, [0x8D]=op_8D, [0x8E]=op_8E, [0x8F]=op_8F, // ADC
    [0x90]=op_90, [0x91]=op_91, [0x92]=op_92, [0x93]=op_93, [0x94]=op_94, [0x95]=op_95, [0x96]=op_96, [0x97]=op_97, // SUB
    [0x98]=op_98, [0x99]=op_99, [0x9A]=op_9A, [0x9B]=op_9B, [0x9C]=op_9C, [0x9D]=op_9D, [0x9E]=op_9E, [0x9F]=op_9F, // SBC
    [0xA0]=op_A0, [0xA1]=op_A1, [0xA2]=op_A2, [0xA3]=op_A3, [0xA4]=op_A4, [0xA5]=op_A5, [0xA6]=op_A6, [0xA7]=op_A7, // AND
    [0xA8]=op_A8, [0xA9]=op_A9, [0xAA]=op_AA, [0xAB]=op_AB, [0xAC]=op_AC, [0xAD]=op_AD, [0xAE]=op_AE, [0xAF]=op_AF, // XOR
    [0xB0]=op_B0, [0xB1]=op_B1, [0xB2]=op_B2, [0xB3]=op_B3, [0xB4]=op_B4, [0xB5]=op_B5, [0xB6]=op_B6, [0xB7]=op_B7, // OR
    [0xB8]=op_B8, [0xB9]=op_B9, [0xBA]=op_BA, [0xBB]=op_BB, [0xBC]=op_BC, [0xBD]=op_BD, [0xBE]=op_BE, [0xBF]=op_BF, // CP

    // --- 8-bit Arithmetic/Logic (Immediate) ---
    [0xC6]=op_C6, [0xCE]=op_CE, [0xD6]=op_D6, [0xDE]=op_DE, [0xE6]=op_E6, [0xEE]=op_EE, [0xF6]=op_F6, [0xFE]=op_FE,

    // --- INC/DEC ---
    [0x04]=op_04, [0x0C]=op_0C, [0x14]=op_14, [0x1C]=op_1C, [0x24]=op_24, [0x2C]=op_2C, [0x34]=op_34, [0x3C]=op_3C, // INC
    [0x05]=op_05, [0x0D]=op_0D, [0x15]=op_15, [0x1D]=op_1D, [0x25]=op_25, [0x2D]=op_2D, [0x35]=op_35, [0x3D]=op_3D, // DEC
    ...
    // --- Loads (Original list) ---
    [0x01]=op_01, [0x11]=op_11, [0x21]=op_21, [0x31]=op_31, // LD R16, nn
    [0x06]=op_06, [0x0E]=op_0E, [0x16]=op_16, [0x1E]=op_1E, [0x26]=op_26, [0x2E]=op_2E, [0x3E]=op_3E, // LD r, n
    [0x22]=op_22, [0x32]=op_32, [0x2A]=op_2A, [0x3A]=op_3A, [0x36]=op_36, // HL Special
    [0xEA]=op_EA, [0xFA]=op_FA, [0x08]=op_08, [0xF9]=op_F9, // Absolute/SP
    [0x02]=op_02, [0x12]=op_12, [0x0A]=op_0A, [0x1A]=op_1A, // BC/DE Indirect
    
    // --- LD B-L (0x40 - 0x7F range) ---
...
void CPU_Flip_Flag(uint8_t flag){ 
	 ...
	 (CPU_Get_Flag(flag)) ? cpu.F &= ~flag : cpu.F |= flag;;
